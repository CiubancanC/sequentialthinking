...
export class InMemoryRoleRepository implements IRoleRepository {
  ...
  private initializeRoles(): void {
    // Architect role
    const architect = Role.create(
      'architect',
      'Architect',
      'As an architect, I focus on designing scalable, maintainable, and secure systems that meet business requirements while following best practices and industry standards.',
      [
    ...
    const seniorDeveloper = Role.create(
      'senior-developer',
      'Senior Developer',
      'As a senior developer, I focus on implementing robust, efficient, and maintainable code while mentoring junior developers and ensuring code quality across the team.',
      [
    ...
    // QA Engineer role
    const qaEngineer = Role.create(
      'qa-engineer',
      'QA Engineer',
      'As a QA engineer, I focus on ensuring software quality through comprehensive testing strategies, automated testing, and identifying potential issues before they reach production.',
      [
    ...
    const devopsEngineer = Role.create(
      'devops-engineer',
      'DevOps Engineer',
      'As a DevOps engineer, I focus on streamlining development and operations processes through automation, CI/CD pipelines, and infrastructure as code to enable faster and more reliable software delivery.',
      [
    ...
    const securityEngineer = Role.create(
      'security-engineer',
      'Security Engineer',
      'As a security engineer, I focus on identifying and mitigating security vulnerabilities, implementing security best practices, and ensuring the overall security posture of the system.',
      [
    ...
    // Data Scientist role
    const dataScientist = Role.create(
      'data-scientist',
      'Data Scientist',
      'As a data scientist, I focus on extracting insights from data, building predictive models, and applying statistical analysis to solve complex business problems.',
      [
    ...
    // UX Designer role
    const uxDesigner = Role.create(
      'ux-designer',
      'UX Designer',
      'As a UX designer, I focus on creating intuitive, accessible, and delightful user experiences through user research, interaction design, and usability testing.',
      [
    ...
    const productManager = Role.create(
      'product-manager',
      'Product Manager',
      'As a product manager, I focus on defining product vision, prioritizing features, and coordinating cross-functional teams to deliver products that meet user needs and business goals.',
      [
  ...
  private initializeScenarios(): void {
    ...
    const architectureScenario = Scenario.create(
      'arch-001',
      'Design a Scalable E-commerce Platform',
      'Design a scalable microservice architecture for an e-commerce platform that can handle high traffic during sales events and provide a seamless shopping experience.',
      'architecture',
      'high',
    ...
    const developmentScenario = Scenario.create(
      'dev-001',
      'Implement a Payment Processing System',
      'Implement a secure payment processing system that integrates with multiple payment gateways and handles various payment methods while ensuring PCI compliance.',
      'development',
      'medium',
    ...
    // Testing scenario
    const testingScenario = Scenario.create(
      'qa-001',
      'Develop a Testing Strategy for a New Feature',
      'Develop a comprehensive testing strategy for a new feature that includes user authentication, data processing, and integration with third-party services.',
      'testing',
      'medium',
    ...
    // DevOps scenario
    const devopsScenario = Scenario.create(
      'devops-001',
      'Set Up a CI/CD Pipeline for a Microservice Architecture',
      'Set up a CI/CD pipeline for a microservice architecture that includes automated testing, deployment, and monitoring across multiple environments.',
      'devops',
      'high',
    ...
    // Security scenario
    const securityScenario = Scenario.create(
      'sec-001',
      'Conduct a Security Assessment of a Web Application',
      'Conduct a comprehensive security assessment of a web application, identify vulnerabilities, and recommend security controls to mitigate risks.',
      'security',
      'high',
    ...
    const dataScenario = Scenario.create(
      'data-001',
      'Build a Recommendation System',
      'Build a recommendation system that analyzes user behavior and preferences to suggest relevant products or content, improving user engagement and conversion rates.',
      'data-science',
      'medium',
      ['Data Scientist', 'Senior Developer']
    );
    this.scenarios.set(dataScenario.id, dataScenario);

    // UX Design scenario
    const uxScenario = Scenario.create(
      'ux-001',
      'Redesign a Mobile App Interface',
      'Redesign the user interface of a mobile app to improve usability, accessibility, and user satisfaction based on user feedback and analytics data.',
      'ux-design',
      'medium',
    ...
    const productScenario = Scenario.create(
      'prod-001',
      'Develop a Product Roadmap for a SaaS Platform',
      'Develop a comprehensive product roadmap for a SaaS platform, prioritizing features based on user needs, market trends, and business goals.',
      'product-management',
      'high',

...
export class RoleLookupService {
     ...
     * @returns The role if found, null otherwise
     */
    findByDirectMatch(normalizedName) {
        // 1. Direct ID lookup
     ...
     * @returns The role if found, null otherwise
     */
    findByFormatNormalization(normalizedName) {
     ...
     * @returns The role if found, null otherwise
     */
    findByPartialMatch(normalizedName) {
     ...
     * @returns The role if found, null otherwise
     */
    findByFuzzyMatch(normalizedName) {
        for (const role of this.roles.values()) {
...
//# sourceMappingURL=roleLookupService.js.map
 ...
 */
export class SequentialThinkingServiceImpl {
    roleService;
     ...
     */
    constructor(roleService, automaticRoleService, repository) {
     ...
     * @returns An array of sequential steps
     */
    async createWorkflowFromScenario(scenario, context) {
        const steps = [];
     ...
     * @returns An array of sequential steps
     */
    async createWorkflowFromContext(context) {
    ...
    async executeStep(step, previousSteps) {
        ...
        const rolePrompt = await this.roleService.generateRolePrompt(step.role.name, enhancedContext);
...
//# sourceMappingURL=sequentialThinkingService.js.map
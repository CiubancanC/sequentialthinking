...
export function createServer() {
    ...
    const helloWorldService = new HelloWorldServiceImpl(repository);
...
export async function runServer() {
    console.error("Hello World MCP Server: Starting runServer function");
    ...
    try {
        ...
        console.error("Hello World MCP Server: runServer function potentially finishing");
    }
}
